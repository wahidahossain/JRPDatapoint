...
<head>
  ...
  <title>JRP Datapoint | Password Reset</title>
...
<div class="card login-form">
	<div class="card-body">
		...
		<form role="form" method="post" action="../model/force_reset_password_admin.php" id="myForm1" class="needs-validation" novalidate>
    <?php
