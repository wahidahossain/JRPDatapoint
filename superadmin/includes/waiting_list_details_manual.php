            ...
            <div class="card">                        
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Manual Assignment to: <?php echo $jrp_account_no;?></h3>&nbsp; &nbsp;<a href="../model/waiting_list_details_manual.php?jrp_account_no=<?php echo $jrp_account_no;?>" class="btn btn-warning btn-sm">Approve Template</a>
                </div>
                <!-- /.card-header -->                                
                    <div class="card-body">
                      <form role="form" action="../model/delete_assign_brands_list_details.php?opt=2" method="POST"> 
