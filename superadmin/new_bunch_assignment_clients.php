...
<div class="wrapper">
 ...
 <?php
  ...
  ?>  
    ...
    <!-- Main content -->
    <?php
  //include("includes/new_bunch_assignment_clients.php");
  include("includes/new_bunch_assignment_clients_new.php");
  ?>    
  </div>
  <?php
...
<script>
    ...
    xmlhttp.open("GET","includes/product_code_list.php?from="+x,true);
    xmlhttp.send();
    }
  </script>
