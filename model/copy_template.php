...
include ("../model/connect.php");
        ...
        {                                                           
                    if($cnt>'0'){
                        ...
                        print("<script>window.location='../superadmin/copy_template.php?index_name=".$index_name."&report_indexes_id=".$report_indexes_id."'</script>");
                    }
                          else{
                        print("<script>window.alert('Template Name already exists, please pick another name for template creation!!');</script>");
                        print("<script>window.location='../superadmin/template_bunch_create_step1.php'</script>");
                          }  
                    }
                    else{
                    ...
                    print("<script>window.location='copy_template_step2.php?index_name=".$index_name."&report_indexes_id_new=".$lastid."&report_indexes_id_old=".$report_indexes_id."'</script>");
        }                                   
