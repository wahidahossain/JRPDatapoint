...
<div class="card login-form">
	<div class="card-body">
		...
		<form role="form" method="post" action="../model/change_password_before_login.php" id="myForm1" class="needs-validation" novalidate>
    <?php
            $user_excol2 = $_REQUEST['user_excol2'];
            $email = $_REQUEST['email'];
            //user_excol2=".$user_excol2."&email=".$email.
            ?>
                <input name = "user_excol2" type="hidden" value=<?php echo $user_excol2;?> >
                <input name = "email" type="hidden" value=<?php echo $email;?> >
		<div class="form-group">
            Password<input type="text" id="pwdId" name="password" class="form-control" pattern="(?=.*\d)(?=.*?[~`!@#$%\^&*()\-_=+[\]{};:\x27.,\x22\\|/?><])(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>           
